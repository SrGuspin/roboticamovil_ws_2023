#!/usr/bin/env python3
# fuente:
# https://github.com/mithi/particle-filter-prototype/tree/master/particle-filter-visualization
import rospy
import numpy as np
...
class ParticlesManager(object):
    ...
    def connections_init(self):
        self.pub_particules = rospy.Publisher(
            'particles', PoseArray, queue_size=10)
    ...
    def create_particles(self, free_positions):
        ...
        for i in range(0, self.num_particles):
            ...
            x, y, ang = pos[0] + gauss(0, self.sigma), pos[1] + \
                gauss(0, self.sigma), random()*2*np.pi
